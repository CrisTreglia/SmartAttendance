...
namespace SmartAttendanceSystem.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var sADbContext = _context.Users.Include(u => u.Profile);
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,Username,ProfileID,Email,Password")] User user)
        {
            ...
            ViewData["ProfileID"] = new SelectList(_context.Profiles, "ProfileID", "ProfileName", user.ProfileID);
            return View(user);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,Username,ProfileID,Email,Password")] User user)
        {
